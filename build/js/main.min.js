...
/* harmony import */ var _modules_init_search_form__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-search-form */ "./js/modules/init-search-form.js");
/* harmony import */ var _modules_form_init_label_moving__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form/init-label-moving */ "./js/modules/form/init-label-moving.js");
/* harmony import */ var _modules_init_cart_calculator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-cart-calculator */ "./js/modules/init-cart-calculator.js");
...
/* harmony import */ var _modules_form_init_custom_select__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/form/init-custom-select */ "./js/modules/form/init-custom-select.js");
/* harmony import */ var _modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/form/init-form-validate */ "./js/modules/form/init-form-validate.js");
/* harmony import */ var _modules_form_auto_resize_textarea__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/form/auto-resize-textarea */ "./js/modules/form/auto-resize-textarea.js");
/* harmony import */ var _modules_remove_no_transition__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/remove-no-transition */ "./js/modules/remove-no-transition.js");
/* harmony import */ var _modules_init_cart_product_counter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-cart-product-counter */ "./js/modules/init-cart-product-counter.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_search_form__WEBPACK_IMPORTED_MODULE_2__["initSearchForm"])();
  Object(_modules_form_init_label_moving__WEBPACK_IMPORTED_MODULE_3__["initLabelMoving"])();
  Object(_modules_init_cart_calculator__WEBPACK_IMPORTED_MODULE_4__["initCartCalculator"])(); // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_form_init_custom_select__WEBPACK_IMPORTED_MODULE_6__["initCustomSelect"])();
    Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_7__["initFormValidate"])();
    Object(_modules_form_auto_resize_textarea__WEBPACK_IMPORTED_MODULE_8__["initAutoResizeTextarea"])();
    Object(_modules_remove_no_transition__WEBPACK_IMPORTED_MODULE_9__["removeNoTransition"])();
    Object(_modules_init_cart_product_counter__WEBPACK_IMPORTED_MODULE_10__["initCartProductCounter"])();
  });
}); // ---------------------------------
...
var orderValidationSuccessCallback = function orderValidationSuccessCallback(e) {
  e.preventDefault();
...
var checkInputValues = function checkInputValues(input, label) {
  if (label) {
...
var initLabelMoving = function initLabelMoving() {
  ...
  if (inputs.length) {
    inputs.forEach(function (el) {
      ...
      var elLabel = el.querySelector('.custom-input__label');
  ...
  if (textareas.length) {
    textareas.forEach(function (el) {
      var elTextarea = el.querySelector('textarea');
      var elLabel = el.querySelector('.custom-textarea__label');
...
/*!********************************************!*\
  !*** ./js/modules/init-cart-calculator.js ***!
  \********************************************/
/*! exports provided: initCartCalculator, updateCart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCartCalculator", function() { return initCartCalculator; });
...
var headerCartCounter = document.querySelector('[data-counter="cart"]');
var cartForm = document.querySelector('.cart__form');

var updateProductPrices = function updateProductPrices() {
  var products = document.querySelectorAll('.produtct-card');
  products.forEach(function (product) {
    var price = product.querySelector('.produtct-card__price output');
    var quantityInput = product.querySelector('.produtct-card__counter input');
    price.textContent = Number(product.dataset.price * quantityInput.value);
  });
};

var updateHeaderCartCounter = function updateHeaderCartCounter() {
  var quantityInputs = cartForm.querySelectorAll('.produtct-card__counter input');

  var counterValue = _toConsumableArray(quantityInputs).reduce(function (sum, current) {
...
var updateCart = function updateCart() {
  var productPrices = document.querySelectorAll('.produtct-card__price output');
  var totalPriceBox = cartForm.querySelector('.cart__total-price');
  var totalPriceValue = totalPriceBox.querySelector('output');
  updateProductPrices();
  updateHeaderCartCounter();

  if (productPrices.length && totalPriceValue) {
    var totalPrice = _toConsumableArray(productPrices).reduce(function (sum, current) {
...
var initCartCalculator = function initCartCalculator() {
  if (!headerCartCounter || !cartForm) {
    return;
  }

  var products = cartForm.querySelector('.cart__products');
  updateCart();
  products.addEventListener('change', function (evt) {
...
/*!*************************************************!*\
  !*** ./js/modules/init-cart-product-counter.js ***!
  \*************************************************/
/*! exports provided: initCartProductCounter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCartProductCounter", function() { return initCartProductCounter; });
/* harmony import */ var _init_cart_calculator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./init-cart-calculator */ "./js/modules/init-cart-calculator.js");


var initCartProductCounter = function initCartProductCounter() {
  var counters = document.querySelectorAll('.cart-product-counter');
  ...
  counters.forEach(function (counter) {
    ...
    var decrementBtn = counter.querySelector('.cart-product-counter__quantity-btn--decrement');
    var incrementBtn = counter.querySelector('.cart-product-counter__quantity-btn--increment');
    ...
    decrementBtn.addEventListener('click', function () {
      ...
      Object(_init_cart_calculator__WEBPACK_IMPORTED_MODULE_0__["updateCart"])();
    });
...
var initSearchForm = function initSearchForm() {
  ...
  var searchBtn = search.querySelector('.search-form__btn');
  var searchinput = search.querySelector('.search-form__input input');

  var onSearchBtnClick = function onSearchBtnClick() {
    searchinput.focus();
  };

  var onSearchBtnFocus = function onSearchBtnFocus() {
    searchinput.focus();
  };
...
/*!********************************************!*\
  !*** ./js/modules/remove-no-transition.js ***!
  \********************************************/
/*! exports provided: removeNoTransition */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeNoTransition", function() { return removeNoTransition; });
var removeNoTransition = function removeNoTransition() {
  var items = document.querySelectorAll('.no-transition');
